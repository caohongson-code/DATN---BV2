    ...
    <div class="card shadow-sm border-0 rounded-3">
        ...
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap"
            ...
            <h5 class="mb-0 fw-bold text-dark">
                <i class="bx bx-memory-card me-2"></i> Danh sách RAM
            </h5>
            <a href="{{ route('rams.create') }}" class="btn btn-create">
        ...
        <div class="card-body">
            ...
            {{-- Form tìm kiếm --}}
            <form method="GET" action="{{ route('rams.index') }}" class="mb-4">
                ...
                <table class="table table-hover table-bordered align-middle text-center mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $ram->value }}</td>
                            <td class="d-flex justify-content-center gap-1">
                                <a href="{{ route('rams.edit', $ram->id) }}" class="btn btn-warning btn-sm" title="Sửa">
