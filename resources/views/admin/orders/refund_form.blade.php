...
<div class="container py-4">
            ...
            <div class="mb-2">
                ...
                <div class="d-flex flex-wrap gap-2 mt-2">
                    @foreach ($images as $img)
                        <img src="{{ asset('storage/' . $img) }}" alt="return image" style="width: 100px; height: auto;" class="img-thumbnail">
                    @endforeach
                </div>
            </div>
        @endif
            ...
            <div class="mb-2">
                ...
                <div class="d-flex flex-wrap gap-2 mt-2">
                    @foreach ($shippingImages as $img)
                        <img src="{{ asset('storage/' . $img) }}" alt="shipping image" style="width: 100px; height: auto;" class="img-thumbnail">
                    @endforeach
                </div>
            </div>
        @endif
    ...
    @else
        ...
        <div class="alert alert-danger">
            <strong>Lưu ý:</strong> Bạn chưa cập nhật <u>số tài khoản ngân hàng</u>. Vui lòng cập nhật để thực hiện hoàn tiền.
        </div>
    @endif
