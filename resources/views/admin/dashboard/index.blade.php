            ...
            @if ($lowStockVariant)
                <a href="{{ route('products.index', $lowStockVariant->product_id) }}" class="text-decoration-none">
                    <div class="card text-white mb-4 shadow-sm"
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <h5 class="mb-0">{{ $lowStockVariantsCount }} sản phẩm</h5>
                            <span class="btn btn-outline-light btn-sm">Xem →</span>
                        </div>
                    </div>
                </a>
                                ...
                                @forelse ($recentOrders as $order)
                                    <tr onclick="window.location.href='{{ route('admin.orders.show', $order->id) }}'"
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="badge bg-info">{{ $order->orderStatus->status_name ?? 'Không xác định' }}</span>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-3">Không có khách hàng mới.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
